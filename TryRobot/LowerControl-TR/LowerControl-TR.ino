...
void setup() {
  ...
  pPIDMotor1->initPID(2.0, 0.0, 0, 0, -baserpm, maxMotRPM - baserpm);//4.2 1.2
  pPIDMotor2->initPID(2.0, 0.0, 0, 0, -baserpm, maxMotRPM - baserpm);//1.1 
  pPIDMotor3->initPID(2.0, 0.0, 0, 0, -baserpm, maxMotRPM - baserpm);//2.0
