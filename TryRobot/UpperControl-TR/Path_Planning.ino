...
//            Serial.print(String(obCounter)+"    ");
    ...
    case nearObstacle:
      lineFlag = traceLine(xJ,yJ,xI,yI,vel,150,250,accdec,CONTINUE,15); // speedMode = constant  //tol = 15
      if(lineFlag)
        planState = nearObstacle;
      else
      {
     ...
     case aroundObstacle:
      ...
      case motionToGoal:
        lineFlag = traceLine(xJ,yJ,xI,yI,400,250,150,accdec,STOP,10); // speedMode = constant  // tol = 15
