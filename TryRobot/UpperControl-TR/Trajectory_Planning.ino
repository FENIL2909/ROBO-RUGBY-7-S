...
bool traceLine(float x1,float y1,float x2,float y2,float vel, float accVel,float passVel, int SpeedMode,int Gmode, float tolerance)
{
...
//              else
//              {      
//              calculateSpeed(-omegacontrol, angleFix, 0); return 0;
//              }
//          }   
//         else 
//              return 0;
